(function (f, e, b, g, c, d, h) { /*! Jssor */
  ...
  var k = f.$JssorEasing$ = {
    ...
    m, i, a = new function () {
      ...
      function mb(a) {
        a.constructor === mb.caller && a.md && a.md()
      }
      i.md = mb;
      i.Z = function (a) {
        if (i.sd(a)) a = e.getElementById(a);
        return a
      };
      ...
      function X(e, a) {
        ...
        if (A()) {
          var l = i.me(d / 180 * b.PI, c, c);
          sb(e, !d && c == 1 ? g : l, i.te(l, a.$OriginalWidth, a.$OriginalHeight))
        } else {
          var j = u(e);
          if (j) {
      ...
      i.ue = function (a, c) {
        if (s() && t < 9 || t < 10 && N()) a.style.zoom = c == 1 ? "" : c;
        else {
          var b = u(a);
          if (b) {
            var f = "scale(" + c + ")",
      ...
      i.Kc = function (c, h, j, i) {
        if (i) c = T(c);
        var d = P(c, h);
        if (!d.length) d = a.Ye(c, h);
        for (var f = d.length - 1; f > -1; f--) {
          var b = d[f],
            e = T(j);
          r(e, r(b));
          a.Vb(e, b.style.cssText);
          var g = a.sc(b);
          a.Xb(g, e, b);
          a.xb(g, b)
        }
    ...
    l = function () {
      ...
      b.g = function (b) {
        ...
        a.b(d, function (a) {
          try {
            a.fc == b && a.jc.apply(f, c)
          } catch (d) {}
        })
      }
    };
  i = function (n, z, i, R, P, L) {
    n = n || 0;
    var e = this,
      r, o, p, x, A = 0,
      I, J, H, C, E = 0,
    ...
    H = i.$During || {};
    I = a.i({
      E: a.Jc(i.$Easing) && i.$Easing || k.$EaseSwing
    }, i.$Easing)
  };
  ...
  new function () {
    ...
    j.$FormationStraight = function (f) {
      for (var d = f.$Cols, e = f.$Rows, k = f.$Assembly, l = f.Yb, j = [], a = 0, b = 0, h = d - 1, i = e - 1, g = l - 1, c, b = 0; b < e; b++)
        for (a = 0; a < d; a++) {
          switch (k) {
          case z:
            c = g - (a * e + (i - b));
    ...
    function K(g, f) {
      ...
      a.i(e, g);
      e.Yb = e.$Cols * e.$Rows;
      if (a.Jc(e.$Easing)) e.$Easing = {
        E: e.$Easing
      };
      e.xd = b.ceil(e.$Duration / e.$Interval);
      e.vd = R(e);
      e.Md = function (b, a) {
        b /= e.$Cols;
        a /= e.$Rows;
        ...
        if (!e.Gb[f]) {
          ...
          for (var c = 0; c < e.$Cols; c++)
            for (var d = 0; d < e.$Rows; d++) e.Gb[f][d + "," + c] = {
              $Top: d * a,
              $Right: c * b + b,
              $Bottom: d * a + a,
              $Left: c * b
    ...
    function L(C, i, e, x, n, k) {
      ...
      if (a.M()) {
        var E = !i["no-image"],
          B = a.Ze(i);
        a.b(B, function (b) {
          (E || b["jssor-slider"]) && a.zb(b, a.zb(b), c)
        })
      }
      a.b(p, function (i, l) {
        a.b(i, function (K) {
          ...
          if (e.$Zoom || e.$Rotate) {
            ...
            if (L) {
              ...
              g.$Zoom = 1;
              if (a.M() || a.gc()) f.$Zoom = b.min(f.$Zoom, 2);
              var R = e.$Rotate;
          ...
          if (M) {
            if (e.$Clip) {
              ...
              if (F && C) {
                p.$Top = h.fb / 2 * x;
                p.$Bottom = -p.$Top
              } else if (F) p.$Bottom = -h.fb * x;
              else if (C) p.$Top = h.fb * x;
              if (E && D) {
                p.$Left = h.bb / 2 * x;
                p.$Right = -p.$Left
              } else if (E) p.$Right = -h.bb * x;
              else if (D) p.$Left = h.bb * x
            }
            s.$Clip = u;
            g.$Clip = h[y]
          }
          ...
          for (var B = e.xd, I = 0; I <= B; I++) {
            ...
            a.b(s, function (f, c) {
              ...
              var j = l[d];
              if (a.nc(f)) i[c] = g[c] + f * j;
              else {
                var h = i[c] = a.i({}, g[c]);
                h.C = [];
                a.b(f.C, function (c, b) {
                  var a = c * j;
                  h.C[b] = a;
                  h[b] += a
                })
    ...
    function m(q, lc) {
      ...
      function uc(n, l) {
        ...
        a.hd = function () {
          S = c;
          Y = g;
          j.g(m.$EVT_SWIPE_START, u(y.Q()), y.Q())
        };
        a.jd = function () {
          S = d;
          k = d;
          var a = y.ff();
          j.g(m.$EVT_SWIPE_END, u(y.Q()), y.Q());
          !a.ub && Jc(a.Te, s)
        };
        a.Fb = function (g, d) {
          var a;
      ...
      function Ec(p, n) {
        ...
        function R(b, g, e) {
          ...
          if (!F) {
            ...
            a.M() && a.S(b, (a.S(b) || 0) + 1);
            if (o.$HWA && a.bc())(!X || a.bc() < 534 || !kb && !a.Mb()) && a.re(b)
          }
          var h = a.H(b);
          a.b(h, function (h) {
            var j = a.D(h, "u");
      ...
      function Cc(F, h, q, v, u) {
        ...
        b.ld = function (b) {
          q && a.eb(ob, b && q.sb.$Outside ? "" : "hidden")
        };
        b.yc = function (b, a) {
          if (k && a >= n) {
            k = d;
        ...
        b.rc(v);
        g = v.T();
        e = g + (a.vc(a.D(F, "idle")) || o.$AutoPlayInterval);
        u.$Shift(e);
        b.W(u);
        f = b.T()
      }
      ...
      function dc(e, g) {
        ...
        if (a.Hb() && a.N() >= 10 && a.N() < 11) e.style.msTransform = "translate(" + c + "px, " + d + "px)";
        else if (a.Mb() && a.N() >= 30 && a.N() < 34) {
      ...
      function gc(e) {
        if (C && (!a.M() || e.button)) {
          ...
          if (f) {
            var j = f.x - zb,
              k = f.y - Ab;
            if (b.floor(E) != E) w = w || nb & N;
            if ((j || k) && !w) {
              if (N == 3)
                if (b.abs(k) > b.abs(j)) w = 2;
                else w = 1;
              else w = N;
              if (X && w == 1 && b.abs(k) - b.abs(j) > 3) Eb = c
            }
            if (w) {
              var d = k,
                i = Gb;
      ...
      var o = a.i({
        ...
        nb = o.$PlayOrientation & 3,
        bc = (o.$PlayOrientation & 4) / -4 || 1,
      ...
      a.Eb(J.$CaptionTransitions);
      var bb = o.$BulletNavigatorOptions,
        O = o.$ArrowNavigatorOptions,
        I = o.$ThumbnailNavigatorOptions,
        W = !o.$UISearchMode,
        x, A = a.B(q, "slides", W),
        jb = a.B(q, "loading", W) || a.jb(e),
        Ob = a.B(q, "navigator", W),
        hc = a.B(q, "arrowleft", W),
        ec = a.B(q, "arrowright", W),
        Nb = a.B(q, "thumbnavigator", W),
        sc = a.j(A),
        rc = a.k(A),
        U, Z = [],
        Bc = a.H(A);
      ...
      var s = -1,
        ...
        ob, w, N, Eb, hb, X, R = [],
        Ub, Wb, Sb, jc, Ic, T, K = o.$PauseOnHover,
        Zb = o.$SlideDuration,
        wb, kb, mb, Vb = v < t,
        H = Vb ? o.$Loop : 0,
        Q, V, G = 1,
      ...
      if (f.navigator.pointerEnabled || (ab = f.navigator.msPointerEnabled)) {
        ...
        if (Q) {
          ...
          a.wb(Bb, ab ? "msTouchAction" : "touchAction", Hb)
        }
      ...
      a.eb(A, "hidden");
      P = cc();
      a.wb(P, "backgroundColor", "#000");
      a.zb(P, 0);
      a.Xb(Bb, P, Bb.firstChild);
      ...
      Mb(db());
      a.e(q, "mouseout", a.Qb(oc, q));
      a.e(q, "mouseover", a.Qb(nc, q));
      Db();
      o.$ArrowKeyNavigation && a.e(e, "keydown", function (a) {
        if (a.keyCode == p.Pe) rb(-1);
        else a.keyCode == p.Be && rb(1)
      });
      var qb = o.$StartIndex;
    ...
    h.Bc = function (D) {
      if (!w) {
        ...
        for (var d = 0; d < t; d++) {
          ...
          a.z(f, h);
          C[d] = h;
          e.$ActionMode & 1 && a.e(h, "click", a.J(g, v, d));
          e.$ActionMode & 2 && a.e(h, "mouseover", a.Qb(a.J(g, v, d), h));
          A[d] = a.Jb(h)
        }
        w = c
      }
  ...
  f.$JssorArrowNavigator$ = function (e, f, s, m) {
    ...
    b.Bc = function (b) {
      if (!p) {
        a.e(e, "click", a.J(g, k, -j));
        a.e(f, "click", a.J(g, k, j));
        a.Jb(e);
        a.Jb(f);
        p = c
      }
  ...
  f.$JssorThumbnailNavigator$ = function (i, A) {
    ...
    function z(o, d) {
      ...
      g.Sc = p;
      k = o.Ne || o.Rb || a.jb();
      g.Lb = b = a.Kc(j, "thumbnailtemplate", k, c);
      l = a.Jb(b);
      e.$ActionMode & 1 && a.e(b, "click", i);
      e.$ActionMode & 2 && a.e(b, "mouseover", a.Qb(i, b))
    }
    h.lc = function (c, d, e) {
      var a = m;
      m = c;
      ...
      function h(c, d) {
        ...
        a.b(p, function (g, h) {
          ...
          if (e) {
            var f = {};
            if (g == "t") f.lb = e;
            else if (e.indexOf("%") + 1) f.Dd = a.vc(e) / 100;
            else f.lb = a.vc(e);
            b[h] = f
          }
        });
        ...
        if (g == "*") h = n();
          ...
          if (a.Kb(e)) {
            ...
            if (a.Kb(e)) {
              ...
              if (a.Kb(e)) e = e[b.floor(b.random() * e.length)]
            }
          }
          h = e;
          if (a.sd(h)) h = d(h)
          ...
          if (f) {
            ...
            if (g && g.sb) {
              ...
              if (j) {
                ...
                if (!n)
                  if (g.kb) i.kb = g.kb.lb || 0;
                  else if (o & 2) i.kb = 0
              }
            }
            c.push(i)
          }
          if (l % 2 && !n) c.H = m(b, l + 1)
        });
        k.push(c)
      });
      return k
